...
def train_es(rng, config, model, params, mle_log, recorder):
    ...
    for gen in t:
        ...
        if (gen + 1) % config.evaluate_every_gen == 0:
            ...
            recorder.write(data={"return": test_fitness_to_log},step=train_evaluator.total_env_steps,step_name="steps")
