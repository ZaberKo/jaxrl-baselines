...
ENV_NAME = flags.DEFINE_string('env_name', 'Asterix', 'What environment to run.')
...
def build_experiment_config():
  ...
  def env_factory(seed):
    del seed
    # return helpers_discrete.make_atari_environment(
    #     level=env_name,
    #     sticky_actions=True,
    #     zero_discount_on_life_loss=False,
    # oar_wrapper=True)
    return helpers_discrete.make_MinAtar_environment(
        level=env_name,
        sticky_actions=True,
        zero_discount_on_life_loss=False,
        oar_wrapper=True)
    # return helpers_discrete.test_MinAtar_environment(level=env_name)
...
def main(_):
  ...
  if RUN_DISTRIBUTED.value:
    ...
    run_experiment.run_experiment(experiment_config)
