...
def train(
  ...
  logging.info(f'num_training_steps_per_epoch: {num_training_steps_per_epoch}')
  ...
  # NOTE: one sgd_step contains multiple minibatch_steps
  ...
  def training_step(
    ...
    #NOTE: f: sample unroll_length timesteps 
    ...
    # data: [batch_size * num_minibatches // num_envs, unroll_length, num_envs, ...]
    ...
    #NOTE: reuse same rollout data `num_updates_per_batch` times
    (optimizer_state, params, _), metrics = jax.lax.scan(
        functools.partial(
